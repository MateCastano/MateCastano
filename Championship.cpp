...
Tambi�n se dispone de una estructura tipo guirnalda compuesta por la clase EQUIPO, formada por el nombre del equipo ( char NOM[20]), el inicio de la lista de jugadores que integran ese equipo
...
Construir la funci�n void MILLONARIO( CAMPEONATO & ) que muestre en pantalla cual es el equipo que m�s gasta mensualmente en sueldos de jugadores y cu�l es ese monto. */
